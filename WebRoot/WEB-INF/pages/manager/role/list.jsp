...
<div class="query">
	<div class="query-conditions ue-clear">
        <div class="conditions input-box ue-clear">
            <label>角色名：</label>
            <input type="text" placeholder="请输入查询的角色名" />
        </div>
    </div>
...
<div class="table-operate ue-clear">
	<a href="${ctx }/role/toAdd" class="add">添加</a>
</div>
<div class="table-box">
	<table>
    	<thead>
        ...
        <tbody>
        	<t:forEach items="${page.recordList }" var="o">
        		<tr>
	                ...
	                <td>${o.name }</td>
	                <td class="operate">
	                	<a href="${ctx }/role/toUpdate?id=${o.id}">修改</a>
	                	<a url="${ctx }/role/${o.id}" onclick="deleteObj(this)">删除</a>
	                </td>
	            </tr>
        	</t:forEach>
        </tbody>
...
<div class="page">
	${page.links }
	<form action="${ctx }/role" id="listForm">
